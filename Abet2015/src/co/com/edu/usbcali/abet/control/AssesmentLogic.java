...
*/
@Scope("singleton")
@Service("AssesmentLogic")
public class AssesmentLogic implements IAssesmentLogic {
    /**
    ...
    /**
    * Logic injected by Spring that manages ListaSepia entities
    *
    */
    @Autowired
    IListaSepiaLogic logicListaSepia1;

    /**
    * Logic injected by Spring that manages RubricaPorCurso entities
    *
    */
    @Autowired
    IRubricaPorCursoLogic logicRubricaPorCurso2;

    @Transactional(readOnly = true)
    public List<Assesment> getAssesment() throws Exception {
        List<Assesment> list = new ArrayList<Assesment>();

        try {
            list = assesmentDAO.findAll();
        } catch (Exception e) {
    ...
    public void deleteAssesment(Long idCodigoAssesment)
        ...
        if (entity == null) {
            throw new ZMessManager().new EmptyFieldException("Assesment");
        }

        try {
            assesmentDAO.delete(entity);
        } catch (Exception e) {
            throw e;
        } finally {
        }
    ...
    public List<AssesmentDTO> getDataAssesment() throws Exception {
        try {
            List<Assesment> assesment = assesmentDAO.findAll();

            List<AssesmentDTO> assesmentDTO = new ArrayList<AssesmentDTO>();

            for (Assesment assesmentTmp : assesment) {
                AssesmentDTO assesmentDTO2 = new AssesmentDTO();

                assesmentDTO2.setIdCodigoAssesment(assesmentTmp.getIdCodigoAssesment());
                assesmentDTO2.setCalificacion((assesmentTmp.getCalificacion() != null)
                    ? assesmentTmp.getCalificacion() : null);
                assesmentDTO2.setIdListaSepia_ListaSepia((assesmentTmp.getListaSepia()
                                                                      .getIdListaSepia() != null)
                    ? assesmentTmp.getListaSepia().getIdListaSepia() : null);
                assesmentDTO2.setIdRubricaPorCurso_RubricaPorCurso((assesmentTmp.getRubricaPorCurso()
                                                                                .getIdRubricaPorCurso() != null)
                    ? assesmentTmp.getRubricaPorCurso().getIdRubricaPorCurso()
                    : null);
                assesmentDTO.add(assesmentDTO2);
            }
    ...
    public Assesment getAssesment(Long idCodigoAssesment)
        ...
        try {
            entity = assesmentDAO.findById(idCodigoAssesment);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Assesment");
        } finally {
        }
    ...
    public List<Assesment> findPageAssesment(String sortColumnName,
        ...
        throws Exception {
        List<Assesment> entity = null;

        try {
            entity = assesmentDAO.findPageAssesment(sortColumnName,
                    sortAscending, startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Assesment Count");
        } finally {
        }
    ...
    public Long findTotalNumberAssesment() throws Exception {
        ...
        try {
            entity = assesmentDAO.findTotalNumberAssesment();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Assesment Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Assesment> findByCriteria(Object[] variables,
        ...
        try {
            list = assesmentDAO.findByCriteria(where);
        } catch (Exception e) {
