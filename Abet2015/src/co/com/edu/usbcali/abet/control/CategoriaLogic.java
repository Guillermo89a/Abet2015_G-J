...
public class CategoriaLogic implements ICategoriaLogic {
    ...
    */
    ...
    public void deleteCategoria(Long idCategoria) throws Exception {
        ...
        if (entity == null) {
            throw new ZMessManager().new EmptyFieldException("Categoria");
        }
    ...
    public List<CategoriaDTO> getDataCategoria() throws Exception {
        try {
            ...
            for (Categoria categoriaTmp : categoria) {
                ...
                categoriaDTO2.setIdCategoria(categoriaTmp.getIdCategoria());
                categoriaDTO2.setNombrecategoria((categoriaTmp.getNombrecategoria() != null)
                    ? categoriaTmp.getNombrecategoria() : null);

                if (categoriaTmp.getRubrica() != null) {
                    categoriaDTO2.setIdRubrica_Rubrica(categoriaTmp.getRubrica()
                                                                   .getIdRubrica());
                } else {
                    categoriaDTO2.setIdRubrica_Rubrica(null);
                }
    ...
    public Categoria getCategoria(Long idCategoria) throws Exception {
        ...
        try {
            entity = categoriaDAO.findById(idCategoria);
        } catch (Exception e) {
    ...
    public List<Categoria> findPageCategoria(String sortColumnName,
        ...
        try {
            entity = categoriaDAO.findPageCategoria(sortColumnName,
    ...
    public Long findTotalNumberCategoria() throws Exception {
        ...
        try {
            entity = categoriaDAO.findTotalNumberCategoria();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Categoria Count");
        } finally {
        }
