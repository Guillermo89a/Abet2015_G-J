package co.com.edu.usbcali.presentation.backingBeans;

import co.com.edu.usbcali.abet.*;
import co.com.edu.usbcali.abet.dto.RubricaDTO;
import co.com.edu.usbcali.exceptions.*;
import co.com.edu.usbcali.presentation.businessDelegate.*;
import co.com.edu.usbcali.utilities.*;
...
//    }
    ...
    public String action_save() {
        try {
            businessDelegatorView.saveRubrica(FacesUtils.checkString(txtNombreRubrica));
            FacesUtils.addInfoMessage(ZMessManager.ENTITY_SUCCESFULLYSAVED);
           } catch (Exception e) {
            FacesUtils.addErrorMessage(e.getMessage());
        }
